    ...
    await withRetry(async () => {
      ...
      if (duplicate) {
        const mergedTopic: Topic = {
          ...
          targetKeyword: newTopic.targetKeyword ?? duplicate.targetKeyword,
          subKeywords: newTopic.subKeywords && newTopic.subKeywords.length > 0 ? newTopic.subKeywords : duplicate.subKeywords,
